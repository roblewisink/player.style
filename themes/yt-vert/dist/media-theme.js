...
class MediaThemeYtVertElement extends MediaThemeElement {
  static template = template;
}

if (globalThis.customElements && !globalThis.customElements.get('media-theme-yt-vert')) {
  globalThis.customElements.define('media-theme-yt-vert', MediaThemeYtVertElement);
}
