...
if (template) {
  ...
  `
    <style>
      ...
      /* always show all controls, even at small breakpoints */
      media-controller[ignore-breakpoints] media-control-bar
        media-play-button,
      media-controller[ignore-breakpoints] media-control-bar
...
var MediaThemeMinimalVertElement = class extends import_media_theme_element.MediaThemeElement {
  static template = template;
};
if (import_server_safe_globals.globalThis.customElements && !import_server_safe_globals.globalThis.customElements.get("media-theme-minimal-vert")) {
  import_server_safe_globals.globalThis.customElements.define("media-theme-minimal-vert", MediaThemeMinimalVertElement);
}
var media_theme_default = MediaThemeMinimalVertElement;
