...
class MediaThemeMinimalVertElement extends MediaThemeElement {
  static template = template;
}

if (globalThis.customElements && !globalThis.customElements.get('media-theme-minimal-vert')) {
  globalThis.customElements.define('media-theme-minimal-vert', MediaThemeMinimalVertElement);
}
